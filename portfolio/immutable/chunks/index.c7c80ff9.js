const e=new Date(Date.now()-new Date("2005-06-19").getTime()).getUTCFullYear()-1970,o={Pages:{aboutButton:"About",projectsButton:"Projects",contactButton:"Contact",linksButton:"Links",codeSnippetsButton:"Code Snippets",supportButton:"Support",buyButton:"Book me on fivver",readMore:"read more",home:{info:"Hi, I am Jonas!"},socials:{headline01:"Coding",headline02:"Social Media",headline03:"Contact",availabilityNoticeWeek:"checked weekly",availabilityNoticeDay:"checked daily",copyNotice:{copy:"copy E-Mail",copied:"copied E-Mail"}},legal:{privacy_policy:{title:"Privacy Policy",content:`<p>Last updated: March 03, 2023</p>
				<p>
				...
				</ul>`,accept:"accept Cookies"},imprint:{title:"Imprint",content:`<p><em>Last updated: June 07, 2025</em></p>
				...
				</p>`}},settings:{title:"Settings",headline01:"Legal",headline02:"Style",headline03:"Language",options:"Options",cookieOptions:{necessary:"Necessary so that the website can save the selected language, the selected style, already loaded icons and the scroll position (will be deleted after closing the tab) of each page on your device!"}},about:{profile:{title:"Profile",text:`My name is <strong>Jonas</strong>, and I am a <strong>${e}</strong>-year-old student currently studying at <strong><a href="https://www.htl-leonding.at/" target="_blank">HTBLA Leonding</a></strong> in <strong>Austria</strong>. I am pursuing a field of study in <strong><a href="https://www.htl-leonding.at/bildungsangebot/medientechnik/" target="_blank">IT/Mediatechnology</a></strong>, and I have a keen interest in programming, especially web development. <br> Aside from my native language, <strong>German</strong>, I am also fluent in <strong>English</strong>, with a B+ level of proficiency. I have experience working with various programming languages, including <strong>HTML</strong>, <strong>CSS</strong>, <strong>Java</strong>, <strong>ShellScript</strong>, <strong>JavaScript & NodeJS</strong>, <strong>PHP</strong>, and <strong>Oracle SQL</strong>. <br> Recently, I have discovered the Svelte JS-framework and learned Svelte along with <strong>SvelteKit</strong>. I have also gained expertise in working with <strong>TailwindCSS</strong> and <strong>DaisyUI</strong>. I am always eager to learn new programming languages and frameworks, and I am passionate about developing efficient, user-friendly websites and applications. I am constantly exploring ways to improve my skills and knowledge in the field of web development, and I am determined to achieve my career goals in the world of IT and programming. With dedication and enthusiasm, I believe that I have what it takes to succeed in this field.`},languages:{navTitle:"Languages",title:"Languages I Speak"},technologies:{navTitle:"Technologies",title:"Technologies I Use",appCircle:"Technology"},photography:{title:"Photography",note:"photographing since 2020"}}},Error:{error:"{error:number} Error",action:"back to homepage"},Header:{home:"Home",about:"About",contact:"Contact",projects:"Projects",legal:"Legal",settings:"Settings"},Footer:{about:{title:"About",list:{photography:"Photography",profile:"Profile",languages:"Languages",technologies:"Technologies",links:"Links"}},contact:{title:"Contact"},projects:{title:"Projects"},legal:{title:"Legal",list:{privacy_policy:"Privacy Policy",terms_and_conditions:"Terms and Conditions",cookies:"Cookies",imprint:"Imprint"}},quote:"quality web developement"}};export{o as default};
