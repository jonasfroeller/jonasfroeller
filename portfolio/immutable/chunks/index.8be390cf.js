const e=new Date(Date.now()-new Date("2005-06-19").getTime()).getUTCFullYear()-1970,o={Pages:{aboutButton:"Über",projectsButton:"Projekte",contactButton:"Kontakt",linksButton:"Links",codeSnippetsButton:"Code Snippets",supportButton:"Unterstützen",buyButton:"Auf Fivver bestellen",readMore:"mehr erfahren",home:{info:"Hi, Ich bin Jonas!"},socials:{headline01:"Programmieren",headline02:"Soziale Medien",headline03:"Kontakt",availabilityNoticeWeek:"wöchentlich eingesehen",availabilityNoticeDay:"täglich eingesehen",copyNotice:{copy:"E-Mail kopieren",copied:"E-Mail kopiert"}},legal:{privacy_policy:{title:"Datenschutz",content:`<center><em>Keine übersetzung vorhanden.</em></center> <br> <p>Last updated: March 03, 2023</p>
				<p>
				...
				</ul>`,accept:"Cookies akzeptieren"},imprint:{title:"Impressum",content:`<p><em>Letzte Aktualisierung: Juni 07, 2025</em></p>
				...
				<p>
					<strong>Zweck der Website:</strong> Persönliches Portfolio<br />- Geschäftstätigkeit über MerginIT e.U.
				</p>

				<h2>Angaben zum Websitebetreiber</h2>
				<p>
				...
				<p>
					<strong>Firmenbuchnummer:</strong> <a href="https://openfirmenbuch.at/company/?fnr=654298d" target="_blank" rel="noopener">654298 d</a><br />
					<strong>Firmenbuchgericht:</strong> Landesgericht Linz<br />
					<strong>Unternehmensgegenstand:</strong> Dienstleistungen in der automatischen Datenverarbeitung und IT<br />
					<strong>UID:</strong> Umsatzsteuerbefreit aufgrund der Kleinunternehmerregelung<br />
				...
				<p>
					...
					E-Mail: <a href="mailto:jonas@merginit.com">jonas@merginit.com</a><br />
					Telefon: +43 6643279885<br /><br />
					<strong>Privat:</strong><br />
					E-Mail: <a href="mailto:j.froe@gmx.at">j.froe@gmx.at</a><br />
					Telefon: +43 6643279885
				</p>

				<p>
					<strong>Vollständiges Impressum:</strong> <a href="https://merginit.com/legal/imprint" target="_blank" rel="noopener">https://merginit.com/legal/imprint</a>
				</p>`}},settings:{title:"Einstellungen",headline01:"Rechtliches",headline02:"Stil",headline03:"Sprache",options:"Optionen",cookieOptions:{necessary:"Erforderlich, damit die Website die gewählte Sprache, den gewählten Stil, bereits geladene Icons und die Scrollposition (wird nach schließen des Tabs gelöscht) jeder Seite auf Ihrem Gerät speichern kann!"}},about:{profile:{title:"Profil",text:`Mein Name ist <strong>Jonas</strong> und ich bin ein <strong>${e}</strong>-jähriger Schüler, der derzeit an der <strong><a href="https://www.htl-leonding.at/" target="_blank">HTBLA Leonding</a></strong> in <strong>Österreich</strong> studiert. Ich studiere <strong><a href="https://www.htl-leonding.at/bildungsangebot/medientechnik/" target="_blank">IT/Medientechnik</a></strong> und interessiere mich sehr für Programmierung, insbesondere Webentwicklung. <br> Neben meiner Muttersprache <strong>Deutsch</strong> spreche ich fließend <strong>Englisch</strong> mit Niveau B+. Spezialisiert habe ich mich auf die Computersprachen <strong>HTML</strong>, <strong>CSS</strong>, <strong>JavaScript & NodeJS</strong>, <strong>PHP</strong>, <strong>Oracle SQL</strong> und <strong>Java</strong>. <br> Kürzlich habe ich das Svelte JS-Framework entdeckt und <strong>Svelte</strong> zusammen mit <strong>SvelteKit</strong> gelernt. Ich habe auch Erfahrungen mit <strong>TailwindCSS</strong> und <strong>DaisyUI</strong> gesammelt. Ich lerne gerne neue Programmiersprachen und Frameworks und entwickle mit Leidenschaft effiziente sowie benutzerfreundliche Websites und Anwendungen. Ich suche ständig nach Möglichkeiten, meine Fähigkeiten und Kenntnisse im Bereich Webentwicklung zu verbessern, und ich bin entschlossen, meine Karriereziele in der Welt der IT und Programmierung zu erreichen. Mit Hingabe und Enthusiasmus glaube ich, dass ich das Zeug dazu habe, in diesem Bereich erfolgreich zu sein.`},languages:{navTitle:"Sprachen",title:"Sprachen in meinem Arsenal"},technologies:{navTitle:"Technologien",title:"Technologien die Ich verwende",appCircle:"Software"},photography:{title:"Fotografie",note:"seit 2020 fotografiere ich"}}},Error:{error:"{error} Fehler",action:"zurück zur homepage"},Header:{home:"Startseite",about:"Über",contact:"Kontakt",projects:"Projekte",legal:"Rechtliches",settings:"Einstellungen"},Footer:{about:{title:"Über",list:{photography:"Fotografie",profile:"Profil",languages:"Sprachen",technologies:"Technologien",links:"Links"}},contact:{title:"Kontakt"},projects:{title:"Projekte"},legal:{title:"Rechtliches",list:{privacy_policy:"Datenschutz",terms_and_conditions:"Geschäftsbedingungen",cookies:"Cookies",imprint:"Impressum"}},quote:"hochwertige Webentwicklung"}};export{o as default};
